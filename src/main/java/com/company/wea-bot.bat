...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="wea-bot" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" com.company.Main.wea_bot %CMD_LINE_ARGS%
